...
#elif CPU == MKL25Z4
    #if UART_NUM == 0
       #define enableUartIrq()   NVIC_EnableIRQ( UART0_IRQn)
       #define disableUartIrq()  NVIC_DisableIRQ(UART0_IRQn)
    #else
       #define enableUartIrq()   NVIC_EnableIRQ( UART1_IRQn)
       #define disableUartIrq()  NVIC_DisableIRQ(UART1_IRQn)
    #endif
#elif CPU == MK20D5
    #if UART_NUM == 0
       #define enableUartIrq()   NVIC_EnableIRQ( UART0_RX_TX_IRQn)
